...
Notes:
I tried to use the google API to get the time to destination from maps(see the commented code in scripts.js). I would love feedback and further assistance on how to get this to work. I feel like I might have been close. Please let me know, I am happy to come into office hrs!
...
snottybot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running snottybot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start snottybot locally by running:
...
Then you can interact with snottybot by typing `snottybot help`.

    snottybot> snottybot help
    snottybot animate me <query> - The same thing as `image me`, except adds [snip]
    snottybot help - Displays all of the help commands that snottybot knows about.
    ...
